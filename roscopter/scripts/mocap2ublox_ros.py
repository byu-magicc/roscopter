...
class Mocap2Ublox():
    ...
    def __init__(self):
        ...
        self.ref_lla = np.array([0.0, 0.0, 1387.0])
    ...
    def publish_rover_virtual_PosVelEcef(self):
        ...
        self.rover_PosVelEcef.position = self.rover_gazebo_PosVelEcef.position#self.ref_ecef + delta_ecef
        ...
        self.rover_PosVelEcef.velocity = self.rover_gazebo_PosVelEcef.velocity#rover_vel_ecef
